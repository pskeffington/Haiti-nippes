"""End-to-end table and mapping pipeline for Haiti Nippes GIS data."""
...
class PipelineResult:
    """Row counts and map outputs generated by a pipeline run."""
    ...
    def summary_lines(self) -> tuple[str, ...]:
        ...
        if self.map_outputs:
            ...
            lines.extend(f"  - {path}" for path in self.map_outputs)
        return tuple(lines)
...
def run_table_pipeline(
    ...
    When ``build_maps`` is true, static maps or placeholder map reports are also
    written after table outputs are generated.
    """
